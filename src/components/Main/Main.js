      ...
      <div className="maindiv">
        <div className="maindiv1">
          {transition((style, item) =>
            item ? (
              <animated.div className="animatediv" style={style}>
        ...
        <div className="maindiv2">
          <div>
            ...
            <div className="aboutdiv">ABOUT ME</div> <br />
            My name is Vishal Sanguri . I am a freelancer <br /> website
            designer and developer <br /> from Uttarakhand , India . I <br />
          ...
          <div className="icons">
            <div
              onClick={() => {
                window.open("https://github.com/vishalsanguri");
              }}
        ...
        <div className="maindiv4">
          ...
          <div className="projectdiv">
            ...
            <div className="projectdiv1">
              ...
              <div className="minidiv">
                Netflix <br />
                Clone of Netflix With User Login. <br />
                <button onClick={openNetflix} className="minidivbutton">
                  visit
                </button>
              </div>
            </div>
            <div className="projectdiv1">
              <div className="minidivimg1"></div>
              <div className="minidiv">
                Weather App <br />
                this app uses weather api to fetch the data. <br />
                <Link to="/weather">
        ...
        <div className="maindiv3">
          <div className="aboutdiv">SKILLS</div> <br />
          <div className="skilldiv">
            <div style={{ marginTop: "5px" }}>
              HTML : 80%
              <br />
              <div className="skillbar">
                <div className="skillbarin1"></div>
              </div>
            </div>
            <div style={{ marginTop: "5px" }}>
              CSS : 90%
